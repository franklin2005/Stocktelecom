...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            <h1 class="h4 mb-1"><i class="bi bi-arrow-repeat me-2"></i>Detalle de transferencia</h1>
        ...
        @php
            ...
            $backUrl = in_array($currentRole, ['admin', 'super_admin', 'logistics'], true)
                ? route('admin.technicians.transfers.history', $technician)
                : url()->previous();
        @endphp
    ...
    <div class="st-card p-3 mb-4">
        ...
        <hr class="my-3">
        <h6 class="mb-2">CONTENIDO DE LA TRANSFERENCIA</h6>
        ...
        @empty
            <p class="st-muted mb-0">Sin líneas registradas para esta transferencia.</p>
        @endforelse
    </div>
@endsection
