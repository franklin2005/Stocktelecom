        ...
        <div class="row g-4">
            <div class="col-12 col-lg-6">
                ...
                <div class="mb-3" id="type-select-wrapper">
                    ...
                    <select id="type_select" class="form-select" aria-describedby="typeHelp">
                        <option value="">Selecciona un tipo</option>
                    </select>
                    <small id="typeHelp" class="st-muted">Puedes escoger un tipo sugerido o escribirlo manualmente.</small>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    typeSelect.addEventListener('change', function (e) {
        if (e.target.value) typeInput.value = e.target.value;
    });
